...
of boilerplate. dash-bootstrap-components reduces this boilerplate by 
providing standard layouts and high-level components.
...
app.title = 'Airbnb Predictor'  # appears in browser title bar
server = app.server
