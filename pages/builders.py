...
column1 = dbc.Col(
    [
        ...
        dcc.Markdown('### Dr Israel Aikulola', className='mb-2'),
        html.P(
                [
        ...
        dcc.Markdown('### Mena Ekelemu', className='mb-2'),
        html.P(
                [
        ...
        dcc.Markdown('### Jack Stanley', className='mb-2'),
        html.P(
                [
        ...
        dcc.Markdown('### Allen Dela Virgen', className='mb-2'),
        html.P(
                [
